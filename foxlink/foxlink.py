...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="foxlink.py", formatter_class=argparse.RawTextHelpFormatter
    )
    ...
    parser.add_argument(
        ...
        default="params.yaml",
        help=(
            "Parameter file used to run FoXlink solver. "
    ...
    parser.add_argument(
        ...
        "--test",
        action="store_true",
        help="Run test protocol on FoXlink solver. NOT IMPLEMENTED YET!",
    )  # TODO
    parser.add_argument(
        "-c",
        "--change_params",
        action="store_true",
        default=False,
        help="Change parameter file if options differ file values. NOT IMPLEMENTED YET!",
    )  # TODO
    parser.add_argument(
        "-a",
        "--analysis",
        ...
        default="",
        help=(
            "Perform post-processing analysis on simulations once completed."
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Graph data after simulation has run and been analyzed. NOT IMPLEMENTED YET!",
    )  # TODO
    parser.add_argument(
        "-m",
        "--movie",
        ...
        default="",
        help=(
            "Make movie of systems of evolution. Options:\n"
...
class FoXlink(object):
    ...
    def get_solver_type(self):
        ...
        """
        try:
            solver_type = getattr(sys.modules[__name__], self._params["solver_type"])
        except KeyError:
            raise
        except ImportError:
            raise
